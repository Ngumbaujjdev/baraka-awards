...
<!-- SEO -->
<title>Cast Your Vote | Digitally Fit Awards</title>
<meta name="description" content="Cast your vote for your favourite nominees on Digitally Fit Awards. Voting is open — support outstanding Kenyan talent and excellence.">
...
<meta itemprop="description" content="Cast your vote for your favourite nominees on Digitally Fit Awards.">
<meta itemprop="image" content="<?= OG_IMAGE ?>">

<!-- Open Graph -->
<meta property="og:title" content="Cast Your Vote | Digitally Fit Awards">
...
<!-- JSON-LD: WebPage -->
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","name":"Cast Your Vote | Digitally Fit Awards","url":"<?= SITE_URL ?>/vote.php","description":"Cast your vote for your favourite nominees on Digitally Fit Awards."}
</script>
...
document.querySelectorAll('.countdown-mini[data-deadline]').forEach(function(wrap) {
    ...
    function tick() {
        ...
        if (diff <= 0) {
            wrap.innerHTML = '<span style="font-size:.85rem;color:#be9b3f;font-weight:600;">Voting closed</span>';
            return;
        }
