...
.tt-badge.sold-out-badge  { background:#fee2e2;color:#a0822f; }
...
.buyer-form input:focus,.buyer-form select:focus {
    border-color:#be9b3f;outline:none;background:#fff;box-shadow:0 0 0 3px rgba(190,155,63,0.08);
}
...
.checkout-alert.error { background:#fff0f0;color:#a0822f;border:1px solid #fca5a5; }
                ...
                <div class="buyer-form">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="buyer_name">Full Name <span style="color:#be9b3f">*</span></label>
                            <input type="text" id="buyer_name" placeholder="e.g. Joshua Ngumbau" autocomplete="name">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="buyer_email">Email Address <span style="color:#be9b3f">*</span></label>
            ...
            for (let i = 0; i < qty; i++) {
                ...
                for (const fk of fields) {
                    ...
                    html += `<div class="col-md-6">
                        <label style="font-size:.78rem;font-weight:700;color:#888;margin-bottom:3px;display:block;">${escHtml(label)}${isReq ? ' <span style="color:#be9b3f">*</span>' : ''}</label>
