...
.contact-form-wrap select:focus {
    ...
    outline: none;
    background: #fff;
    box-shadow: 0 0 0 3px rgba(190,155,63,0.1);
}
...
.ci-social-links a:hover { background: #be9b3f; color: #fff; }
...
.alert-error-custom {
    ...
    border: 1px solid rgba(190,155,63,0.25);
    border-radius: 8px;
    padding: 14px 18px;
    margin-bottom: 20px;
    color: #a0822f;
