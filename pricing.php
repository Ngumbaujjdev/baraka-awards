...
<meta name="keywords" content="Baraka Awards pricing, event platform pricing Kenya, awards management cost Kenya, ticketing system pricing, voting platform Africa, event ticketing fees Kenya, awards platform subscription, online voting platform cost, affordable event management Kenya, gala management pricing, East Africa event platform">
...
.enterprise-banner::before {
    ...
    height: 220px;
    border-radius: 50%;
    background: radial-gradient(circle, rgba(190,155,63,0.2) 0%, transparent 70%);
}
...
.enterprise-banner .stat-item .stat-n { font-size: 2rem; font-weight: 900; color: #be9b3f; line-height: 1; }
...
.pfaq-q .pfaq-icon { color: #be9b3f; font-size: .8rem; transition: transform .25s; }
                ...
                <div class="col-lg-7">
                    ...
                    <div class="ent-actions">
                        ...
                        <a href="mailto:<?= ADMIN_EMAIL ?>"
                           ...
                           onmouseover="this.style.borderColor='#be9b3f';this.style.color='#be9b3f';"
