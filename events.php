...
.event-block .date-badge {
    ...
    background: #be9b3f; color: #fff; border-radius: 8px;
...
.events-search-wrap input:focus { border-color: #be9b3f; }
...
.events-pagination button:hover { border-color: #be9b3f; color: #be9b3f; }
.events-pagination button.active { background: #be9b3f; border-color: #be9b3f; color: #fff; }
...
.events-empty i { font-size: 3rem; color: #be9b3f; opacity: .35; }
...
(function () {
    ...
    function buildCard(e) {
        ...
        var voteBtn = isVoting
            ? '<a href="' + DATA.siteUrl + '/nominees?event=' + encodeURIComponent(slug) + '" class="theme-btn btn-style-two" style="background:#be9b3f;border-color:#be9b3f;"><span class="btn-title"><i class="fas fa-vote-yea" style="margin-right:4px;"></i>Vote Now</span></a>'
            : '';
