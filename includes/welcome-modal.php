...
.wm-top{background:linear-gradient(135deg,#0a0a0a 0%,#1a1a1a 100%);padding:32px 28px 24px;text-align:center;color:#fff;}
...
.wm-btn-tickets{background:#0a0a0a;color:#fff;}
.wm-btn-learn{background:#f5f5f5;color:#0a0a0a;}
...
.wm-dismiss button:hover{color:#0a0a0a;}
</style>
...
<div id="welcomeModal" role="dialog" aria-modal="true" aria-label="Welcome to Digitally Fit Awards">
    <div class="wm-card">
        <div class="wm-top">
            ...
            <img src="<?= SITE_URL ?>/assets/images/logo/dfa-logo-white.svg" alt="Digitally Fit Awards" onerror="this.style.display='none'">
...
function dismissWelcome() {
    localStorage.setItem('dfa_welcomed', Date.now());
    var modal = document.getElementById('welcomeModal');
