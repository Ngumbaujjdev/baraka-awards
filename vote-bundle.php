...
.nominee-pick-card:hover,.nominee-pick-card.selected { border-color:#be9b3f; background:#fff8f8; }
.nom-thumb {
...
.nominee-pick-card.selected .nom-pick-check { background:#be9b3f; border-color:#be9b3f; }
...
.bundle-card:hover,.bundle-card.selected { border-color:#be9b3f; box-shadow:0 4px 18px rgba(190,155,63,.1); background:#fff8f8; }
...
.bundle-card.selected .bundle-pick-check { background:#be9b3f; border-color:#be9b3f; }
...
.pay-btn {
    ...
    background:linear-gradient(135deg,#be9b3f,#a0822f); border:none;
...
.step-label i { color:#be9b3f; margin-right:5px; }

/* Alert */
.vote-alert { border-radius:10px; padding:13px 16px; margin-bottom:18px; font-size:.87rem; }
.vote-alert.error { background:#fff0f0; color:#a0822f; border:1px solid #fca5a5; }
            ...
            <div class="col-lg-7 col-md-12">
                ...
                <div id="customAmountSection" style="background:#fff;border:2px solid #eee;border-radius:12px;padding:18px 20px;transition:border-color .2s,background .2s;">
                    <div style="font-size:.75rem;font-weight:800;color:#aaa;text-transform:uppercase;letter-spacing:.8px;margin-bottom:12px;">
                        <i class="fas fa-coins" style="color:#be9b3f;margin-right:5px;"></i>Enter any amount
                    </div>
                ...
                <div class="voter-form" id="step3Section">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="voter_name">Full Name <span style="color:#be9b3f;">*</span></label>
                            <input type="text" id="voter_name" placeholder="e.g. Jane Wanjiku" autocomplete="name">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="voter_email">Email Address <span style="color:#be9b3f;">*</span></label>
                            <input type="email" id="voter_email" placeholder="your@email.com" autocomplete="email">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label for="voter_phone">Phone Number <span style="color:#be9b3f;">*</span></label>
    ...
    <div style="max-width:540px;margin:0 auto;">
        ...
        <div style="display:flex;gap:8px;">
            ...
            <button id="mobBtnCard" onclick="VotePage.pay('card')"
                    style="flex:2;padding:12px 8px;border-radius:8px;border:none;background:linear-gradient(135deg,#be9b3f,#a0822f);color:#fff;font-weight:800;font-size:.9rem;cursor:pointer;">
...
window.VotePage = (function () {
    ...
    function calcCustomVotes(val) {
        ...
        if (customSec) { customSec.style.borderColor = '#be9b3f'; customSec.style.background = '#fff8f8'; }
        renderSummary();
        updateStepUI();
    ...
    function pay(method) {
        ...
        $confirmBtn.style.background = method === 'mpesa'
            ...
            : 'linear-gradient(135deg,#be9b3f,#a0822f)';
