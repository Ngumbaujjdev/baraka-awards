...
.nom-search-wrap input:focus { border-color: #be9b3f; }
...
<div class="voting-strip">
    ...
    <a href="<?= SITE_URL ?>/nominees?event=<?= urlencode($slug) ?>"
       ...
       style="background:#fff;color:#be9b3f;border-color:#fff;font-size:.82rem;padding:8px 22px;">
        ...
        <div class="row">
            ...
            <div class="content-side col-lg-8 col-md-12 col-sm-12">
                ...
                <div style="display:flex;flex-wrap:wrap;gap:14px;margin-bottom:22px;align-items:center;">
                    <span style="font-size:.88rem;color:#555;"><i class="fa fa-calendar-alt" style="color:#be9b3f;margin-right:6px;"></i><?= $dateStr ?></span>
                    <?php if (!empty($event['start_time'])): ?>
                    <span style="font-size:.88rem;color:#555;"><i class="fa fa-clock" style="color:#be9b3f;margin-right:6px;"></i><?= date('h:i A', strtotime($event['start_time'])) ?><?= !empty($event['end_time']) ? ' – ' . date('h:i A', strtotime($event['end_time'])) : '' ?></span>
                    <?php endif; ?>
                    <?php if (!empty($event['venue_name'])): ?>
                    <span style="font-size:.88rem;color:#555;"><i class="fa fa-map-marker-alt" style="color:#be9b3f;margin-right:6px;"></i><?= htmlspecialchars($event['venue_name'] . ($event['venue_city'] ? ', ' . $event['venue_city'] : '')) ?></span>
                    <?php endif; ?>
                    <?php if ($isVirtual): ?>
                    <span style="font-size:.88rem;color:#555;"><i class="fa fa-video" style="color:#be9b3f;margin-right:6px;"></i>Virtual Event</span>
                    <?php elseif ($eventFormat === 'hybrid'): ?>
                    <span style="font-size:.88rem;color:#555;"><i class="fa fa-layer-group" style="color:#be9b3f;margin-right:6px;"></i>Hybrid Event</span>
                    <?php endif; ?>
                </div>
                ...
                <?php if ($isVotingOpen): ?>
                <div style="display:flex;align-items:flex-start;gap:14px;background:linear-gradient(135deg,#fff1f2,#ffe4e6);border:2px solid #be9b3f;border-radius:12px;padding:20px 24px;margin-bottom:22px;">
                    <i class="fas fa-vote-yea" style="font-size:1.6rem;color:#be9b3f;margin-top:2px;flex-shrink:0;"></i>
                    <div style="flex:1;">
                ...
                <div class="tab-content">
                            ...
                            <div class="tabs-content">
                                ...
                                <div class="tab <?= $di===0?'active-tab':'' ?>" id="sday-<?= $di ?>">
                                    ...
                                    <div class="schedule-day-header-custom" style="margin-bottom:20px;">
                                        <h6><i class="fas fa-calendar-day me-2" style="color:#be9b3f;"></i><?= date('l, d F Y', strtotime($day['date'])) ?></h6>
                                    </div>
                                    <?php endif; ?>
                            ...
                            <div class="col-md-4 col-sm-6 mb-4">
                                <div class="speaker-card">
                                    ...
                                    <div style="margin-top:8px;">
                                        <span style="font-size:.7rem;background:rgba(190,155,63,0.1);color:#be9b3f;padding:2px 8px;border-radius:20px;font-weight:700;">Featured</span>
                                    </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="tab-nominees">
                        ...
                        <div class="nom-phase-banner voting-open">
                            <i class="fas fa-vote-yea" style="color:#be9b3f;font-size:1.4rem;margin-top:2px;flex-shrink:0;"></i>
                            <div>
                                <strong style="color:#be9b3f;display:block;margin-bottom:4px;">Voting is open!</strong>
            ...
            <div class="sidebar-side col-lg-4 col-md-12 col-sm-12">
                <aside class="sidebar padding-left">
                    ...
                    <?php if (!empty($event['has_voting'])): ?>
                    <?php if ($isVotingOpen): ?>
                    <div style="background:linear-gradient(135deg,#be9b3f,#a0822f);border-radius:12px;padding:26px;text-align:center;color:#fff;margin-bottom:24px;">
                        ...
                        <a href="<?= SITE_URL ?>/nominees?event=<?= urlencode($slug) ?>"
                           class="theme-btn btn-style-two" style="display:block;text-align:center;background:#fff;color:#be9b3f;border-color:#fff;">
                            <span class="btn-title" style="color:#be9b3f;"><i class="fas fa-vote-yea me-2"></i> Vote Now</span>
                        </a>
                    </div>
                    ...
                    <div class="sidebar-widget">
                        ...
                        <div class="widget-content">
                            <ul style="list-style:none;padding:0;margin:0;">
                                ...
                                <li style="border-bottom:1px solid #f0f0f0;">
                                    <a href="<?= SITE_URL ?>/nominees" style="display:flex;align-items:center;gap:10px;padding:10px 0;color:#333;text-decoration:none;font-size:.9rem;font-weight:500;" onmouseover="this.style.color='#be9b3f'" onmouseout="this.style.color='#333'">
                                        <i class="fa fa-users" style="color:#be9b3f;width:18px;text-align:center;flex-shrink:0;"></i>
                                        All Nominees
                                    </a>
                                </li>
                                <li style="border-bottom:1px solid #f0f0f0;">
                                ...
                                <li>
                                    <a href="<?= SITE_URL ?>/nominate.php?event=<?= urlencode($slug) ?>" style="display:flex;align-items:center;gap:10px;padding:10px 0;color:#333;text-decoration:none;font-size:.9rem;font-weight:500;" onmouseover="this.style.color='#be9b3f'" onmouseout="this.style.color='#333'">
                                        <i class="fa fa-pen-nib" style="color:#be9b3f;width:18px;text-align:center;flex-shrink:0;"></i>
                                        Nominate Someone
                                    </a>
                                </li>
                                <?php endif; ?>
            ...
            <div class="modal-body" style="padding:24px 22px;">
                ...
                <div style="display:flex;align-items:flex-start;gap:18px;margin-bottom:18px;">
                    ...
                    <div style="flex:1;min-width:0;padding-top:4px;">
                        ...
                        <!-- Subtitle / role -->
                        <div id="modal-nom-subtitle" style="font-size:.9rem;color:#be9b3f;font-weight:700;margin-bottom:6px;"></div>
                        <!-- Voting code -->
