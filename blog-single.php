...
.sidebar-widget.search-box input[type="search"]:focus { border-color:#be9b3f; }
.sidebar-widget.search-box button {
    position:absolute;right:6px;top:50%;transform:translateY(-50%);
    background:#be9b3f;border:none;border-radius:50%;width:34px;height:34px;
    color:#fff;cursor:pointer;font-size:.85rem;
}
.sidebar-widget.search-box button:hover { background:#a0822f; }
...
.popular-tags .widget-content a:hover { background:#be9b3f;color:#fff;border-color:#be9b3f; }
...
.blog-meta-icon { color:#be9b3f;margin-right:5px; }
.blog-cat-pill { background:#be9b3f;color:#fff;font-size:.72rem;font-weight:700;padding:3px 12px;border-radius:20px;text-transform:uppercase;letter-spacing:.8px; }
