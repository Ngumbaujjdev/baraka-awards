...
<link rel="canonical" href="https://mema.memaawards.africa/faq.php">
...
<meta property="og:url" content="https://mema.memaawards.africa/faq.php">
...
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://mema.memaawards.africa/"},{"@type":"ListItem","position":2,"name":"FAQ","item":"https://mema.memaawards.africa/faq.php"}]}
</script>

<!-- JSON-LD: WebPage -->
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","name":"Frequently Asked Questions | Digitally Fit Awards","url":"https://mema.memaawards.africa/faq.php","description":"Find answers to common questions about Digitally Fit Awards events, voting, nominations, and tickets."}
</script>
...
.faq-category-title { font-weight: 800; color: #053732; font-size: 1.1rem; margin-bottom: 20px; display: inline-block; }
.accordion-button { font-weight: 600; font-size: .92rem; color: #053732; background: #fff; box-shadow: none; }
...
.faq-sidebar-link { display: block; padding: 10px 14px; border-radius: 8px; font-size: .88rem; font-weight: 600; color: #053732; text-decoration: none; transition: all .2s; margin-bottom: 4px; }
...
.faq-sidebar-links a { color: #053732; font-size: .88rem; text-decoration: none; }
...
.faq-cta { background: linear-gradient(135deg, #053732, #0a5c50); border-radius: 14px; padding: 36px; text-align: center; color: #fff; margin-top: 10px; }
            ...
            <div class="content-side col-lg-8 col-md-12">
                ...
                <div class="mb-5">
                    ...
                    <div class="accordion" id="faqGeneral">
                        <div class="accordion-item"><h2 class="accordion-header"><button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#g1">What is Digitally Fit Awards?</button></h2><div id="g1" class="accordion-collapse collapse show" data-bs-parent="#faqGeneral"><div class="accordion-body">MEMA — the Myogenic Excellent Music Awards — is Kenya's first dedicated gospel music awards ceremony, celebrating outstanding talent across performance, production, videography, and photography. The inaugural MEMA Gala takes place on 16 September 2026 in Nairobi.</div></div></div>
                        <div class="accordion-item"><h2 class="accordion-header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#g2">What does MEMA stand for?</button></h2><div id="g2" class="accordion-collapse collapse" data-bs-parent="#faqGeneral"><div class="accordion-body">MEMA stands for <strong>Myogenic Excellent Music Awards</strong>. "Myogenic" reflects energy born from within — the spirit-driven creativity at the very heart of gospel music. It speaks to artists who create not for fame alone, but from a deep inner calling.</div></div></div>
                        <div class="accordion-item"><h2 class="accordion-header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#g3">When and where is the MEMA Gala?</button></h2><div id="g3" class="accordion-collapse collapse" data-bs-parent="#faqGeneral"><div class="accordion-body">The inaugural MEMA Gala takes place on <strong>16 September 2026</strong> at the <strong>Radisson Blu Hotel &amp; Convention Centre, Nairobi</strong>. Doors open at 4:30 PM. Get your tickets on the <a href="tickets" style="color:#be9b3f;">Tickets page</a>.</div></div></div>
                        <div class="accordion-item"><h2 class="accordion-header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#g4">How many award categories are there?</button></h2><div id="g4" class="accordion-collapse collapse" data-bs-parent="#faqGeneral"><div class="accordion-body">MEMA 2026 has <strong>9 award categories</strong>: Female Artist of the Year, Male Artist of the Year, Emerging Gospel Artist of the Year, Gospel Song of the Year, Gospel Video of the Year, Gospel Collaboration of the Year, Audio Producer of the Year, Video Director of the Year, and Photography of the Year.</div></div></div>
                    </div>
                </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="accordion" id="faqTickets">
                        <div class="accordion-item"><h2 class="accordion-header"><button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#o1">How do I buy tickets?</button></h2><div id="o1" class="accordion-collapse collapse show" data-bs-parent="#faqTickets"><div class="accordion-body">Visit the <a href="tickets" style="color:#be9b3f;">Tickets page</a>, choose your preferred tier, and complete the secure online payment via M-Pesa or card. Your e-ticket will be sent to your email immediately after payment.</div></div></div>
                        <div class="accordion-item"><h2 class="accordion-header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#o2">What ticket options are available?</button></h2><div id="o2" class="accordion-collapse collapse" data-bs-parent="#faqTickets"><div class="accordion-body">MEMA Gala 2026 offers several tiers: <strong>Individual Seat</strong> (KES 1,000), <strong>Couple</strong> (KES 1,800), <strong>Table of 10</strong> (KES 9,000), and <strong>VIP Bundle</strong>. Check the <a href="tickets" style="color:#be9b3f;">Tickets page</a> for current availability and any early-bird offers.</div></div></div>
                        <div class="accordion-item"><h2 class="accordion-header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#o3">Can I get a refund?</button></h2><div id="o3" class="accordion-collapse collapse" data-bs-parent="#faqTickets"><div class="accordion-body">Tickets are non-refundable. If you have a genuine concern, please contact us at <a href="mailto:info@memaawards.co.ke" style="color:#be9b3f;">info@memaawards.co.ke</a> and the team will do their best to assist.</div></div></div>
                        <div class="accordion-item"><h2 class="accordion-header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#o4">Is there a dress code?</button></h2><div id="o4" class="accordion-collapse collapse" data-bs-parent="#faqTickets"><div class="accordion-body">Smart or formal attire is encouraged. The MEMA Gala is a prestigious awards night — dress to celebrate and honour the occasion!</div></div></div>
                        <div class="accordion-item"><h2 class="accordion-header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#o5">Where exactly is the venue?</button></h2><div id="o5" class="accordion-collapse collapse" data-bs-parent="#faqTickets"><div class="accordion-body">The MEMA Gala 2026 is held at the <strong>Radisson Blu Hotel &amp; Convention Centre, Upper Hill, Nairobi</strong>. Parking is available on site. Doors open at 4:30 PM on 16 September 2026.</div></div></div>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="accordion" id="faqTechnical">
                        ...
                        <div class="accordion-item"><h2 class="accordion-header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#t3">How do I report a bug?</button></h2><div id="t3" class="accordion-collapse collapse" data-bs-parent="#faqTechnical"><div class="accordion-body">Use the <a href="contact" style="color:#be9b3f;">Contact</a> page. Include the page URL, description of the issue, and your device/browser. Our team aims to respond within 24 hours.</div></div></div>
                    </div>
                </div>
                ...
                <aside class="sidebar padding-left" style="position:sticky;top:100px;">
                    ...
                    <div class="sidebar-widget faq-sidebar-box">
                        ...
                        <ul class="list-unstyled faq-sidebar-links mb-0">
                            <li><a href="nominees"><i class="fas fa-users me-2" style="color:#be9b3f;"></i>View Nominees</a></li>
                            <li><a href="nominees"><i class="fas fa-vote-yea me-2" style="color:#be9b3f;"></i>Vote Now</a></li>
                            <li><a href="tickets"><i class="fas fa-ticket-alt me-2" style="color:#be9b3f;"></i>Buy Tickets</a></li>
                            <li><a href="nominate"><i class="fas fa-user-plus me-2" style="color:#be9b3f;"></i>Submit a Nomination</a></li>
                            <li><a href="contact"><i class="fas fa-envelope me-2" style="color:#be9b3f;"></i>Contact Us</a></li>
                        </ul>
                    </div>
                </aside>
            </div>
